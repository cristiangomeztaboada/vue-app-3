<template>
  <div class="row">
      ...
      <div class="input-group mb-3">
        ...
        <div class="input-group-append">
          <button
            ...
            data-bs-target="#modalPagoPresupuesto"
          >
            🔎
          </button>
        </div>
    ...
    <div class="modal" id="modalPagoPresupuesto" tabindex="-1">
      <div class="modal-dialog modal-xl">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <pago-presupuesto-grid
              v-bind:mostrarColumnaBotones="false"
              v-on:seleccionarPagoPresupuesto="
                recibirPagoPresupuestoSeleccionado
              "
            />
          </div>
        </div>
...
export default {
  ...
  setup(props, context) {
    ...
    const recibirPagoPresupuestoSeleccionado = function (c) {
