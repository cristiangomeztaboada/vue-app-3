    ...
    <div class="col-sm-11 col-md-11 col-lg-11 col-xl-11">
      <div class="card text-center shadow-lg p-3 mb-5 bg-white rounded">
        ...
        >
          ...
          <template #personalplantaidsolicitantenombre>
            <b style="color: black">SOLICITANTE</b>
          </template>
          <DxColumn
            data-field="personalplantaidsolicitante.nombre"
            header-cell-template="personalplantaidsolicitantenombre"
          />
          <template #personalplantaidsolicitadonombre>
            <b style="color: black">SOLICITADO A</b>
          </template>
          <DxColumn
            data-field="personalplantaidsolicitado.nombre"
            header-cell-template="personalplantaidsolicitadonombre"
          />
