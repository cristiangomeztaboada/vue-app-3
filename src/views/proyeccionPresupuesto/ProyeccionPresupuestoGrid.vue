  ...
  <div class="row d-flex justify-content-center">
    <div class="col-sm-11 col-md-11 col-lg-11 col-xl-11">
      <div class="card text-center shadow-lg p-3 mb-5 bg-white rounded">
        <div class="row">
          <div class="col-sm-11 col-md-11 col-lg-11 col-xl-11">
            <h1 class="display-6">Proyección Presupuesto</h1>
          </div>
        ...
        <DxDataGrid
          ...
          @row-click="seleccionarProyeccionPresupuesto"
          :showRowLines="true"
        >
          <DxEditing :use-icons="true" mode="row"> </DxEditing>
          <DxSearchPanel :visible="true" :highlight-case-sensitive="true" />
          <DxColumn data-field="periodoid.codigo" />
  ...
  setup(props, context) {
    ...
    const listar = function () {
      api
        ...
        .then((data) => {
          api
            .listarProyeccionPresupuesto(data[0].codigo, store.state.institucioneducativa)
            .then((data) => {
    ...
    const seleccionarProyeccionPresupuesto = function (e) {
      context.emit("seleccionarProyeccionPresupuesto", e.data.codigo);
    };

    const eliminar = function (rowData) {
      if (window.confirm("Desea eliminar este registro?")) {
        api
          .eliminarProyeccionPresupuesto(rowData.row.values[0])
          .then(() => listar())
          .catch(function (e) {
            mensajeAlerta.value = e;
          });
    ...
    return {
      mensajeAlerta,
      dataSource,
      seleccionarProyeccionPresupuesto,
      eliminar,
      editar,
      nuevo,
    };
