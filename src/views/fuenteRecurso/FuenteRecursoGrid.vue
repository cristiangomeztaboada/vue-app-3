    ...
    <div class="col-sm-11 col-md-11 col-lg-11 col-xl-11">
      <div class="card text-center shadow-lg p-3 mb-5 bg-white rounded">
        ...
        <DxDataGrid
          ...
          @row-click="seleccionarFuenteRecurso"
          :showRowLines="true"
          :row-alternation-enabled="true"
        >
          <DxEditing :use-icons="true" mode="row"> </DxEditing>
          <DxSearchPanel :visible="true" :highlight-case-sensitive="true" />
          <template #fuenteRecursoCodigoPadre>
            <b style="color: black">CÓDIGO PADRE</b>
          </template>
          <DxColumn data-field="idpadre.codigo" header-cell-template="fuenteRecursoCodigoPadre" />
          <template #fuenteRecursoCodigo>
            <b style="color: black">CÓDIGO</b>
          </template>
          <DxColumn data-field="codigo" header-cell-template="fuenteRecursoCodigo"/>
          <template #fuenteRecursoNombre>
            <b style="color: black">NOMBRE</b>
          </template>
          <DxColumn data-field="nombre" header-cell-template="fuenteRecursoNombre"/>
